...
def main():
    ...
    parser.add_argument(
        ...
        default="full",
        type=str,
        choices=["full", "acg", "wvf"],
        help="dataset name",
    )
    parser.add_argument(
        "--num-labeled", type=int, default=24, help="number of labeled data"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--arch",
        default="cerebellum_full",
        type=str,
        choices=["cerebellum_acg", "cerebellum_full", "cerebellum_wvf"],
        help="dataset name",
    )
    parser.add_argument(
    ...
    parser.add_argument("--batch-size", default=40, type=int, help="train batchsize")
    parser.add_argument(
        "--lr",
        "--learning-rate",
        default=0.004265516314362439,
        type=float,
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help="coefficient of unlabeled loss",  #!hyperparam
    )
    parser.add_argument(
        "--T", default=1, type=float, help="pseudo label temperature"
    )  #! hyperparam
    parser.add_argument(
        "--threshold",
        default=0.95,
        type=float,
        help="pseudo label threshold",  #! hyperparam
    )
    parser.add_argument(
